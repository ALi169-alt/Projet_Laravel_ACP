...
<h5 class="text-uppercase mb-0 mt-0 page-title">Demande de Conge :</h5>
</div>
...
<div class="col-lg-6 col-md-6 col-sm-6 col-12">    
<form class="custom-mt-form" action="{{url('/conge-maladie/store')}}" method="post" enctype='multipart/form-data'> <!-- @@@@@@@@@ Form1 @@@@@@@-->
